function [xyh, proj] = llh2xyh_new(llh, proj, ell)
...
if nargin < 3; ell  = get_ellipsoid('WGS84'); end;

% set default projection parameters if the central meridian is invalid
...
H = h - anomaly; % - geoid_h(llh, 'egm2008');
